...
fn main() {
 ...
 for x in 1..=amount_of_user{
      let v = vec!["Office adminstrator","Academic","Lawyer","Teacher"];
    ...
    if index == 0{
        ...
        let e = vec!["Intern","Administrator","Senior Administrator","Office Manager","Director","CEO"];
    ...
    if index == 1{
        ...
        let c = vec!["Research Assistant","PhD Candidate","Post-Doc Researcher","Senior Lecturer","Dean"];
   ...
   if index == 2{
     ...
     let t = vec!["Parallegal","Junior Associate","Associate","Senior Associate 1-2","Senior Associate 3-4","Partner"];
    ...
    if index == 3{
        ...
        let o = vec!["Placement","Classroom Teacher","Snr Teacher","Leading Teacher","Deputy Principal","Principal"];
